...
/***************ADD***************/
  ...
  uint32_t dxl_id_12_position_i_gain;
  uint32_t dxl_id_12_position_d_gain;
  uint32_t dxl_id_12_feedforward_1st_gain;
  uint32_t dxl_id_12_feedforward_2nd_gain;
  uint32_t dxl_id_13_position_p_gain;
  uint32_t dxl_id_13_position_i_gain;
  uint32_t dxl_id_13_position_d_gain;
  uint32_t dxl_id_13_feedforward_1st_gain;
  uint32_t dxl_id_13_feedforward_2nd_gain;
