...
class DynamixelState {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int16(obj.position_p_gain, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.position_p_gain = _deserializer.int16(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return 'de16fe707b0f52dae3981fe25709b978';
  }
