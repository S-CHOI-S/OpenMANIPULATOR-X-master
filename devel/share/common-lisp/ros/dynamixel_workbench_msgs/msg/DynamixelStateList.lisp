...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DynamixelStateList>)))
  ...
  "ca6b404a6eaea9a9b5692e9c615fd4e1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DynamixelStateList)))
  "Returns md5sum for a message object of type 'DynamixelStateList"
  "ca6b404a6eaea9a9b5692e9c615fd4e1")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DynamixelStateList>)))
  ...
  (cl:format cl:nil "# DynamixelState List~%~%DynamixelState[] dynamixel_state~%~%================================================================================~%MSG: dynamixel_workbench_msgs/DynamixelState~%# This message includes basic data of dynamixel~%~%string name~%uint8  id~%~%int32  present_position~%int32  present_velocity~%int16  present_current~%~%## ADD~%int16  position_p_gain~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DynamixelStateList)))
  "Returns full string definition for message of type 'DynamixelStateList"
  (cl:format cl:nil "# DynamixelState List~%~%DynamixelState[] dynamixel_state~%~%================================================================================~%MSG: dynamixel_workbench_msgs/DynamixelState~%# This message includes basic data of dynamixel~%~%string name~%uint8  id~%~%int32  present_position~%int32  present_velocity~%int16  present_current~%~%## ADD~%int16  position_p_gain~%~%~%"))
