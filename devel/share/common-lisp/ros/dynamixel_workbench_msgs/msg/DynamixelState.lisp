...
(cl:defmethod position_p_gain-val ((m <DynamixelState>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DynamixelState>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'position_p_gain)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 65536) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    )
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DynamixelState>) istream)
  "Deserializes a message object of type '<DynamixelState>"
    ...
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'position_p_gain) (cl:if (cl:< unsigned 32768) unsigned (cl:- unsigned 65536))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DynamixelState>)))
  ...
  "de16fe707b0f52dae3981fe25709b978")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DynamixelState)))
  "Returns md5sum for a message object of type 'DynamixelState"
  "de16fe707b0f52dae3981fe25709b978")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DynamixelState>)))
  ...
  (cl:format cl:nil "# This message includes basic data of dynamixel~%~%string name~%uint8  id~%~%int32  present_position~%int32  present_velocity~%int16  present_current~%~%## ADD~%int16  position_p_gain~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DynamixelState)))
  "Returns full string definition for message of type 'DynamixelState"
  (cl:format cl:nil "# This message includes basic data of dynamixel~%~%string name~%uint8  id~%~%int32  present_position~%int32  present_velocity~%int16  present_current~%~%## ADD~%int16  position_p_gain~%~%~%"))
