...
(defsystem "open_manipulator_msgs-srv"
  ...
  :components ((:file "_package")
    (:file "DockBatteryService" :depends-on ("_package_DockBatteryService"))
    (:file "_package_DockBatteryService" :depends-on ("_package"))
    ...
    (:file "KillManipulatorService" :depends-on ("_package_KillManipulatorService"))
    (:file "_package_KillManipulatorService" :depends-on ("_package"))
